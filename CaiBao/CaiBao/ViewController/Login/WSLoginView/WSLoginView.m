...
- (void)creatVisulBg {
    ...
    imageview.image = [UIImage imageNamed:LoginBackImage];
...
//    imgLogin.clipsToBounds = YES;
    ...
    [self.loginBtn setBackgroundColor:CB_rgb_hex(0xFF694E)];
    [self.loginBtn setTitleColor:[UIColor whiteColor] forState:UIControlStateNormal];
    [self.loginBtn addTarget:self action:@selector(LoginAction:) forControlEvents:UIControlEventTouchUpInside];
    [smallView addSubview:self.loginBtn];
    
    self.registerBtn = [[UIButton alloc]initWithFrame:CGRectMake(10, CGRectGetMaxY(self.loginBtn.frame)+10, smallView.frame.size.width-20, 40)];
    [self.registerBtn setTitle:@"注册" forState:UIControlStateNormal];
    self.registerBtn.layer.cornerRadius = 5;
    [self.registerBtn setBackgroundColor:CB_rgb_hex(0x033789)];
    ...
    [smallView addSubview:self.registerBtn];
    
    
    
    smallView.frame = CGRectMake(20, 150, self.frame.size.width-40, CGRectGetMaxY(self.registerBtn.frame)+15);
...
- (void)LoginAction:(UIButton *)sender
{
    ...
    if (_loginBlock) {
        _loginBlock(self.textField1.text, self.textField2.text);
    }
}
...
- (void)RegisterAction:(UIButton *)sender
{
    ...
    if (_registerBlock) {
        _registerBlock(self.textField1.text, self.textField2.text);
    }
}

- (void)setLoginBlock:(ClicksLoginBlock)clickBlock
{
    _loginBlock = [clickBlock copy];
}
